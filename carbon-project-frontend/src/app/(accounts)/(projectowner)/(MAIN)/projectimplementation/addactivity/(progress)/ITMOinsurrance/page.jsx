...
export default function ITMOInsurrancePage() {
            ...
            <div className="bg-white rounded-lg shadow-md p-8 flex-1 flex flex-col justify-between">
              <div>
                ...
                <div className="mb-6">
                  ...
                  <button
                    type="button"
                    className={`flex items-center gap-2 mb-2 focus:outline-none ${selectedOption === 'upload' ? '' : 'opacity-70'} cursor-pointer`}
                  ...
                  {selectedOption === 'upload' && (
                    <>
                      ...
                      <button
                        type="button"
                        onClick={() => router.push("/projectimplementation/addactivity/acknowledgement")}
                        disabled={!file}
                        className={`px-6 py-2 rounded transition mb-4 ${
                        file
                        ? 'bg-[#32623A] text-white hover:bg-[#29512f]'
                  ...
                  <button
                    type="button"
                    className={`flex items-center gap-2 text-gray-700 mt-2 mb-2 focus:outline-none ${selectedOption === 'verification' ? '' : 'opacity-70'} cursor-pointer`}
                    onClick={() => setSelectedOption('verification')}
                    tabIndex={0}
                    aria-pressed={selectedOption === 'verification'}
                  >
                  ...
                  {selectedOption === 'verification' && (
                    <button
                      type="button"
                      onClick={() => router.push("/projectimplementation/addactivity/acknowledgement")}
                      className="px-6 py-2 bg-[#32623A] text-white rounded hover:bg-[#29512f] transition mt-4"
                    >
                      Submit
                    </button>
                  )}
