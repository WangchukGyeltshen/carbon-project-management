...
export default function WaitingRequest() {
    ...
    <div className="w-full bg-white rounded-xl shadow p-8 ml-auto">
      ...
      <div className="border border-dashed border-green-900 rounded-lg p-12 min-h-[200px] flex items-center justify-center bg-white" style={{ borderWidth: 1 }}>
        <span className="text-green-900 text-center">
          Waiting for RGoB to Verify your Request
        </span>
      </div>
      <div className="flex justify-end gap-4 mt-8">
        <button
          ...
          type="button"
          onClick={() => router.push("/projectimplementation/addactivity/ITMOinsurrance")}
        >
          Previous
        </button>
        <button
          ...
          type="button"
          onClick={() => router.push("/projectimplementation/addactivity/acknowledgement/letter")}
        >
          Next
        </button>
      </div>
