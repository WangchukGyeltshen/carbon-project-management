...
type InsightType = "warning" | "error" | "info" | string;
...
export default function ActionableInsights({ insights, loading }: { insights?: InsightItem[]; loading: boolean }): React.ReactElement {
  if (loading) {
    return (
