        ...
        {steps.map((item, idx) => {
          if (idx + 1 < step) {
            return (
              <div key={idx} className="flex items-center gap-3">
                ...
                <button type="button" className="flex-1 text-left px-4 py-2 rounded font-semibold border whitespace-nowrap bg-green-50 text-green-700 border-green-200">
                  {item.label}
                </button>
              </div>
            );
          ...
          if (idx + 1 === step) {
            return (
              <div key={idx} className="flex items-center gap-3">
                ...
                <button type="button" className="flex-1 text-left px-4 py-2 rounded font-semibold border whitespace-nowrap bg-[#32623A] text-white border-[#32623A]">
                  {item.label}
                </button>
              </div>
            );
          ...
          return (
            <div key={idx} className="flex items-center gap-3">
              ...
              <button type="button" className="flex-1 text-left px-4 py-2 rounded font-semibold border whitespace-nowrap bg-white text-gray-700 border-gray-300">
                {item.label}
              </button>
            </div>
          );
