              ...
              <div className="w-full bg-white rounded-xl shadow p-8 ml-auto">
                ...
                >
                  <span className="block bg-green-50 text-green-900 p-4 rounded-md text-sm leading-relaxed">
                    Your Request to Issue ITMOs/MCUs has been approved. Based on
                    Request, following units have been issued:
                    <br />
                    &nbsp;&nbsp;&nbsp;&nbsp;a. ITMO: 24 tCO2e
                    <br />
                    &nbsp;&nbsp;&nbsp;&nbsp;b. MCU: 12 tCO2e
                ...
                <div className="flex justify-end gap-4 mt-8">
                  <button
                    ...
                    onClick={() =>
                      router.push(
                        "/User/MAIN/projectimplementation/addactivity/progress/ITMOinsurrance"
                      )
                    }
                  >
                    Previous
                  ...
                  <button
                    ...
                    onClick={() =>
                      router.push(
                        "/User/MAIN/projectimplementation/addactivity/progress/PEletter"
                      )
                    }
                  >
                    Next
